...
@Rule(key = XPathDeploymentTypeCodeCheck.RULE_KEY)
public class XPathDeploymentTypeCodeCheck extends SimpleXPathBasedCheck {

    public static final String RULE_KEY = "DeploymentTypeCodeCheck_RULE_KEY";
    public static final int MINIMUM_TYPE_CODE = 10000;

    private final XPathExpression allTypeCodesExpression = XPathBuilder
            .forExpression(".//@typecode")
            .build();
